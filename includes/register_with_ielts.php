...
if(isset($_POST)){
    ...
    $class_preference= $_POST['class_preference'];
    ...
    $emailSubject = 'IELTS Registration Request Submitted by '.$name;

    $htmlContent = '<h2>IELTS Request</h2>
            <h4>Name</h4><p>'.$name.'</p>
            <h4>E Mail</h4><p>'.$email.'</p>
            <h4>Contact</h4><p>'.$contact_number.'</p>
            <h4>Class Preference</h4><p>'.$class_preference.'</p>';
