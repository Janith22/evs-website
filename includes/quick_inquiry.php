...
if(isset($_POST)){
    ...
    $quick_inquiry_page_name= $_POST['quick_inquiry_page_name'];
    $name= $_POST['name'];
    $email= $_POST['email'];
    ...
    $emailSubject = 'Quick Inquiry by '.$name;

 $htmlContent = '<h2>Quick Inquiry</h2>
            <h4>Name</h4><p>'.$name.'</p>
            <h4>E-Mail</h4><p>'.$email.'</p>
            <h4>Contact Number</h4><p>'.$contact_number.'</p>
            <h4>Country</h4><p>'.$country.'</p>
            <h4>Visa Type</h4><p>'.$type_of_visa.'</p>
            <h4>Page Name</h4><p>'.$quick_inquiry_page_name.'</p>
            <h4>Duration</h4><p>'.$duration.'</p>
            <h4>Civil Status</h4><p>'.$civil_status.'</p>
